...
@ComponentScan({ "com.fa.cybercore" })
@EnableJpaRepositories(basePackages = "com.fa.cybercore.repository")
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.fa.cybercore.model");
